...
<body class="bg-gray-100 font-sans">
    <div class="max-w-7xl mx-auto py-12 px-6">
        <div class="bg-white p-8 rounded-lg shadow-lg">
            <h2 class="text-2xl font-semibold text-gray-700 mb-6">Property Listing</h2>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="date" id="start_date" name="start_date" class="mt-1 block w-full border border-gray-300 rounded-lg p-2" required>
                        </div>
                        
                        <div>
                            <label for="end_date" class="block text-sm font-medium text-gray-700">End Date</label>
                            <input type="date" id="end_date" name="end_date" class="mt-1 block w-full border border-gray-300 rounded-lg p-2" required>
                        </div>

                        <div>
                            <label for="photo" class="block text-sm font-medium text-gray-700">Upload Photo</label>
                            <input type="file" id="photo" name="photo" class="mt-1 block w-full border border-gray-300 rounded-lg p-2" accept="image/*">
                        </div>
                        ...
                        <!-- Amenities (to be populated dynamically from the database) -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Amenities</label>
                            <div class="space-y-2">
                                <!-- Sample amenities, these should be populated dynamically from your database -->
                                <div class="flex items-center">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="pool" class="ml-2 text-sm text-gray-700">Swimming Pool</label>
                                </div>
                                <div class="flex items-center">
                                ...
                                <!-- Add more amenities as required -->
                            </div>
                        </div>
                    </div>
